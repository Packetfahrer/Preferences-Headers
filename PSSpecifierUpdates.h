...
-(BOOL)reloadSpecifierAtIndex:(unsigned)arg1 ;
-(BOOL)insertSpecifier:(id)arg1 atIndex:(unsigned)arg2 ;
-(BOOL)insertSpecifier:(id)arg1 afterSpecifier:(id)arg2 ;
-(BOOL)insertContiguousSpecifiers:(id)arg1 atIndex:(unsigned)arg2 ;
-(BOOL)insertContiguousSpecifiers:(id)arg1 afterSpecifier:(id)arg2 ;
-(BOOL)removeSpecifier:(id)arg1 ;
-(BOOL)removeSpecifierAtIndex:(unsigned)arg1 ;
...
-(BOOL)appendSpecifiers:(id)arg1 toGroupAtGroupIndex:(unsigned)arg2 ;
...
-(BOOL)removeSpecifiersInGroupAtGroupIndex:(unsigned)arg1 ;
-(BOOL)reloadSpecifiersInRange:(NSRange)arg1 ;
-(BOOL)reloadSpecifiersInGroupAtGroupIndex:(unsigned)arg1 ;
-(BOOL)reloadSpecifierWithID:(id)arg1 ;
-(BOOL)moveSpecifierAtIndex:(unsigned)arg1 toIndex:(unsigned)arg2 ;
-(BOOL)swapSpecifierAtIndex:(unsigned)arg1 withSpecifierAtIndex:(unsigned)arg2 ;
...
-(BOOL)appendSpecifier:(id)arg1 toGroupAtGroupIndex:(unsigned)arg2 ;
...
-(BOOL)moveSpecifier:(id)arg1 toIndex:(unsigned)arg2 ;
